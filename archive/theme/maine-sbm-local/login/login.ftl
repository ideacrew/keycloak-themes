            ...
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                ...
                <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                  ...
                  <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                      <input tabindex="6" class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" type="button" onclick="window.location.href='https://cme-enroll.dev/insured/consumer_role/privacy?uqhp=true';" value="Create Account" />
                  ...
                  <div class="broker-box">
                    ...
                    <span>Brokers and Maine Enrollment Assisters <a tabindex="8" href="https://cme-enroll.dev/benefit_sponsors/profiles/registrations/new?profile_type=broker_agency">register here</a></span> 
                  </div>
            </form>
        </#if>
        </div>
