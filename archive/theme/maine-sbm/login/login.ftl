            ...
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                ...
                <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                  ...
                  <div class="broker-box">
                    ...
                    <span>Brokers and Maine Enrollment Assisters <a tabindex="8" href="https://preprod-enroll.cme.openhbx.org/benefit_sponsors/profiles/registrations/new?profile_type=broker_agency">register here</a></span> 
                  </div>
            </form>
        </#if>
        </div>
